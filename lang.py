traducciones = {
    'es': {
        ...
        #botones y textos de la interfaz en español
        'guardar': 'Guardar',
        'cancelar': 'Cancelar',
        'activos': 'Activos',
        'usuarios': 'Usuarios',
        ...
        'tag': 'Etiqueta',
        'save': 'Guardar',
        'search_placeholder': 'Buscar por nombre, etiqueta o propietario',

        # Exportar
        'export_title': 'Exportar activos',
        'export_description': 'Haz clic en el botón para generar el archivo Excel con todos los activos registrados.',
        ...
        # Login
        'login_title': 'Login',
        'login_header': 'Acceso al sistema',
        'username': 'Usuario',
        'password': 'Clave',
        ...
        'close': 'Cerrar',
        'filtrar_por_tipo': 'Filtrar por tipo',
        'todos': 'Todos',  
        'hardware': 'Hardware',
        'red': 'Red',
        'software': 'Software',
        ...
        'tag': 'Tag',
        'save': 'Save',
        'search_placeholder': 'Search by name, tag or owner',

        # Export
        'export_title': 'Export assets',
        'export_description': 'Click the button to generate the Excel file with all registered assets.',
        ...
        "total_integraciones": "Total de integraciones",
        "total_relaciones": "Total de relaciones",
        "buscar_integraciones": "Buscar integraciones",
        "buscar_relaciones": "Buscar relaciones",
        "validacion_iso": "Validación ISO",
        "ver_detalles": "Ver detalles",
        "validacion_iso": "Validación ISO 27001",
        "relaciones_ci": "Relaciones CI",
